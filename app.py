...
QUESTIONS_EXEMPLES = [
    "Signes de la pneumonie lobaire aiguë ?",
    "Prise en charge de l'infarctus (SCA ST+) ?",
    "Étiologies d'une hypercalcémie ?",
    "Critères de Duke (endocardite) ?",
    "Traitement de la crise d'asthme sévère ?",
    "Complications microvasculaires du diabète ?",
    "Signes ECG de l'embolie pulmonaire ?",
    "Bilan d'une anémie macrocytaire ?",
    "Critères de gravité de la pancréatite ?",
    "Traitement de la méningite communautaire ?",
    "Indications de l'oxygénothérapie (BPCO) ?",
    ...
    "Évaluation du risque CV (SCORE) ?",
    "Traitement de la pyélonéphrite simple ?",
    "Causes d'insuffisance rénale fonctionnelle ?",
    "Signes de l'occlusion intestinale aiguë ?",
    "Diagnostic d'une appendicite aiguë ?",
    "Médicaments de la colique néphrétique ?",
    "Signes de l'insuffisance cardiaque gauche ?",
    "Traitement de la FA mal tolérée ?",
    "Signes ECG d'une hyperkaliémie ?",
    "Diagnostic de la tuberculose pulmonaire ?",
    "Prise en charge de l'état de mal épileptique ?",
    "Signes d'hypertension intracrânienne ?",
    "Dépistage du mélanome (règle ABCDE) ?",
    "Red flags devant une céphalée aiguë ?"
]
